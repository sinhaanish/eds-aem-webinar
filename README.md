...
## Environments
- Preview: https://main--eds-aem-webinar--sinhaanish.aem.page/
- Live: https://main--eds-aem-webinar--sinhaanish.aem.live/
...
1. Open the `eds-aem-webinar` directory in your favorite IDE and start coding :)
